...
static void cb_submit(Fl_Button*, void*) {
  std::string Twt_str, Twb_str, Ti_str, TC_str, dens_str, SH_str, visc_str, MF_str; //Po_str
...
Fl_Double_Window* make_window() {
  { main_window = new Fl_Double_Window(678, 749, "Laminar Combustion Input File Generator");
    { bc_set = new Fl_Group(190, 30, 475, 475, "Boundary Conditions");
      { iso_button_t = new Fl_Round_Button(510, 145, 25, 25, "Isothermal (top");
      ...
      { adia_button_t = new Fl_Round_Button(510, 164, 25, 25, "Adiabatic (top)");
      ...
      { iso_button_b = new Fl_Round_Button(510, 182, 25, 25, "Isothermal (Bottom)");
      ...
      { adia_button_b = new Fl_Round_Button(510, 199, 25, 25, "Adiabatic (bottom)");
    ...
    { gas_set = new Fl_Group(185, 257, 475, 473, "Gas Settings");
      { gas_tc = new Fl_Input(510, 266, 130, 25, "Thermal Conductivity");
      } // Fl_Input* gas_tc
      { gas_dens = new Fl_Input(510, 290, 130, 25, "Density");
      } // Fl_Input* gas_dens
      { gas_sh = new Fl_Input(510, 315, 130, 25, "Specific Heat");
      } // Fl_Input* gas_sh
      { gas_visc = new Fl_Input(510, 340, 130, 25, "Viscosity");
      } // Fl_Input* gas_visc
      { gas_mf = new Fl_Input(510, 365, 130, 25, "Percent Fuel");
      } // Fl_Input* gas_mf
      gas_set->end();
    } // Fl_Group* gas_set
    { chem_set = new Fl_Group(185, 433, 475, 477, "Chemistry Settings");
      { rx_rate = new Fl_Input(510, 442, 130, 25, "Reaction Rate");
      } // Fl_Input* rx_rate
      { fuel_h = new Fl_Input(510, 464, 130, 25, "Enthalpy of Fuel");
      } // Fl_Input* fuel_h
      chem_set->end();
    } // Fl_Group* chem_set
    { mesh_set = new Fl_Group(185, 527, 475, 475, "Mesh Settings");
      { x_elem = new Fl_Input(510, 542, 130, 25, "Elements (X)");
      } // Fl_Input* x_elem
      { y_elem = new Fl_Input(510, 567, 130, 25, "Elements (Y)");
      } // Fl_Input* y_elem
      { xmax = new Fl_Input(510, 592, 130, 25, "X Max");
      } // Fl_Input* xmax
      { ymax = new Fl_Input(510, 617, 130, 25, "Y Max");
      } // Fl_Input* ymax
      mesh_set->end();
    } // Fl_Group* mesh_set
    { time_set = new Fl_Group(185, 657, 475, 675, "Time Settings");
      { duration = new Fl_Input(510, 682, 130, 25, "Number of Steps");
      } // Fl_Input* duration
      { timestep = new Fl_Input(510, 707, 130, 25, "Timestep");
      } // Fl_Input* timestep
      time_set->end();
    } // Fl_Group* time_set
